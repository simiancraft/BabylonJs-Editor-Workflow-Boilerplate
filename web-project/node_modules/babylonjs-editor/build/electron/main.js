...
class EditorApp {
    ...
    static Create() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Create web server
            this.Server = new web_server_1.default();
     ...
     */
    static CreateWindow() {
        settings_1.default.OpenedFile = process.argv[1];
 ...
 */
const firstLoad = electron_1.app.requestSingleInstanceLock();
/**
 * Events
 */
if (firstLoad) {
    electron_1.app.on('second-instance', (event, commandLine, workingDirectory) => {
        if (EditorApp.Window) {
            ...
            if (filename !== settings_1.default.OpenedFile) {
                settings_1.default.OpenedFile = filename;
